...
<style>
	*{padding: 0;font-size: 12px;}
	...
	#AllWrap{margin:0 auto; text-align:center; align:center;}
	#RadioBox{margin:0 0 10px 0;text-align:left;}
	#IdBox{border:10px solid rgb(218, 218, 218);padding: 10px; width: 50%;  }
...
<body>
	...
	<table id="InputTable" align="center">
		...
		<tr>
			<th><span class="bullet">&gt;</span><strong>아이디</strong></th>
			<td>
	...
	<div>
		...
		<br><br><br>
		비밀번호를 찾기 위해서 아이디, 이름, 휴대전화를 입력하세요.
		<br><br><br>
	</div>
	</div>    
